...
if dataset == 'heart':
    ...
    data = get_ads_data(n=5000, random_state=1) # TODO: edit n and random state? Try with all data too
...
# TODO: edit how to select use_pca

accuracy_results, consistency_results = run_experiments(data = data, reps = reps, keeps = keeps, deletes=deletes, methods = methods, use_pca=True)
